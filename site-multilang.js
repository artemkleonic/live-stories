(function () {
  ...
  var TEXT = {
    ru: {
      ...
      "modal.title": "Один сайт. Три двери.",
      "modal.text": "Выберите язык библиотеки. Если рассказ ещё не переведён, он не притворяется существующим.",
    ...
    en: {
      ...
      "modal.title": "One site. Three doors.",
      "modal.text": "Select the language of the library. If a story has not yet been translated, it does not pretend to exist.",
    ...
    ua: {
      ...
      "modal.title": "Один сайт. Троє дверей.",
      "modal.text": "Оберіть мову бібліотеки. Якщо оповідання ще не перекладене, воно не вдає, ніби вже існує.",
